...
flunder_client_t::~flunder_client_t() { disconnect(); }
...
auto flunder_client_t::publish(std::string_view topic,
                               const char *value) const //
    -> int {
  return publish_string(topic, std::string{value});
}

auto flunder_client_t::publish(std::string_view topic, const void *data,
                               size_t len) const //
    -> int {
...
auto flunder_client_t::publish(std::string_view topic, const void *data,
                               size_t len, std::string_view encoding) const //
    -> int {
...
auto flunder_client_t::publish_raw(std::string_view topic, const void *data,
                                   size_t len) const //
    -> int {
  return _impl->publish_raw(topic, data, len);
}

auto flunder_client_t::publish_custom(std::string_view topic, const void *data,
                                      size_t len,
...
auto flunder_client_t::subscribe(std::string_view topic,
...
auto flunder_client_t::add_mem_storage(std::string_view name,
...
FLECS_EXPORT int flunder_get(const void *flunder, const char *topic,
                             flunder_variable_t **vars, size_t *n) {
  *n = 0;
  *vars = nullptr;
