...
TEST(flunder, init)
{
    ...
    auto res = client_1.connect("localhost", 7447);
    ASSERT_EQ(res, 0);
...
TEST(flunder, pub_sub)
{
    ...
    client_1.connect("localhost", 7447);
    client_2.connect("localhost", 7447);
...
TEST(flunder, c)
{
    ...
    auto res = flunder_connect(client, "localhost", 7447);
    ASSERT_EQ(res, 0);
